...
-- Sample HTTP logs (last 7 days)
INSERT INTO http_logs
SELECT
    now() - INTERVAL number % (7 * 24 * 60) MINUTE as timestamp,
...
INSERT INTO metrics
SELECT
    now() - INTERVAL number % (24 * 60) MINUTE as timestamp,
...
INSERT INTO events
SELECT
    now() - INTERVAL number % (30 * 24 * 60) MINUTE as timestamp,
...
-- Sample service health (last 7 days, every 5 minutes)
...
FROM numbers(2016);  -- 7 days * 24 hours * 12 (every 5 minutes)
